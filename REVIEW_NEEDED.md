...
| Russian and Uzbek | There are no human-reviewed translations yet. | Add human-reviewed translations and glossary before multilingual ranking. |

## Technical decisions already made

- The first model comparison will use English as the primary language.
- Uzbek is `uz-UZ` in Latin script.
